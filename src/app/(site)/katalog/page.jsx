...
/*
  ...
  yang dipakai bertransaksi. Dipasangkan dengan `createPublicClient()` (tanpa
  cookie, supaya halamannya boleh di-cache), katalog tersaji nyaris seketika;
  stok tetap divalidasi ulang saat checkout di /menu.
*/
