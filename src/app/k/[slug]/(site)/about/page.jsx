...
export const metadata = {
  title: 'About',
  description: 'Cerita di balik outlet kami — kedai kopi yang menjalankan sistemnya sendiri.',
};
        ...
        <Container>
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Button href={tenantPath(tenant.slug, '/katalog')}>Lihat Menu Kami</Button>
